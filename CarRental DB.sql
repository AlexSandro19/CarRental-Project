...
CREATE TABLE brandModels(
	brandModel_id 	INT				PRIMARY KEY		NOT NULL		AUTO_INCREMENT,
...
CREATE TABLE zip_codes(
	zip				INT		PRIMARY KEY		NOT NULL		AUTO_INCREMENT,
...
(3, 2, 3, "2020-05-21 14:00:00", "2020-05-25 14:00:00", 300,  10000);DROP DATABASE IF EXISTS carRental;
CREATE DATABASE carRental;
